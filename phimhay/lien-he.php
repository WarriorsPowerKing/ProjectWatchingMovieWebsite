			...
			<div class="col-sm-12">
				<div class="contact-info">
					...
					<address style="margin-left: 30px">
						<p><b>PHIM HAY</b></p>
						<p><b>Trường Đại Tôn Đức Thắng</b></p>
						<p>Đường Nguyễn Hữu Thọ, Tân Hưng, Quận 7, Hồ Chí Minh
</p>
						<p>Mobile: 0779864648 </p>
						<p>Email: 517H0153@student.tdtu.edu.vn</p>
					</address>
				</div>
			</div>
			<div class="col-sm-12" style="margin-top: 20px">
				<div class="contact-form">
					...
					<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="#" onsubmit="return valid()">
						...
						<div class="form-group col-md-6" style="margin-left: 42px;">
