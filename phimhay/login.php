            ...
            <div align="center">
              ...
              <h2 class="title title-lienhe">Đăng nhập</h2>
					<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="#" onsubmit="return valid()">
						<div>
							<input type="text" name="username" placeholder="Tài khoản"  style="margin-top:10px; height:30px; border-radius:4px;">
						</div>
						<div  >
							<input type="password" name="password" placeholder="Mật khẩu" style="margin-top:10px; height:30px; border-radius:4px;">
						</div>
