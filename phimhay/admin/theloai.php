							...
							<form role="form">
								<table>
									<tr>
										...
										<td><input type="text" id="theloai" class="form-control"></td>
									</tr>
									<tr>
										<td></td>
                    ...
                    <div class="col-lg-6">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        <th class="col-md-1">Mã thể loại</th>
                                ...
                                <tbody>
									...
									$db=new DB_Connect();
									$conn=$db->connect();
									$result = mysqli_query($conn, 'select count(id) as total from theloai');
									...
									$config = array(
										...
										'limit'         => 10,
										'link_full'     => 'theloai.php?page={page}',
										'link_first'    => 'theloai.php',
										'range'         => 10 
									);
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-3">'.$row['theloai'].'</td>
