...
<ul class="nav navbar-nav side-nav">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<h2 align="center" style="color:red">Bình luận của người xem </h2>
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <?php
									$sql="select id,taikhoan,phim,binhluan  from binhluan";
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-1">'.$row['taikhoan'].'</td>									
										<td class="col-md-1">'.$row['phim'].'</td>
										<td class="col-md-1">'.$row['binhluan'].'</td>
	...
	<script src="/phimhay/admin/js/binhluan.js"></script>
